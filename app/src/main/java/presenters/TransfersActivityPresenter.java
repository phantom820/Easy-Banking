...
public class TransfersActivityPresenter {
    ...
    public TransfersActivityPresenter(View view, List<Account>accounts){
        this.view=view;
        ...
        if(validatePayment()){
            ...
            call.enqueue(new Callback<Object>() {
                ...
                public void onFailure(Call<Object> call, Throwable t) {
                    view.showErrorSnackBar("Transfer unsuccessful");
                ...
                public void onResponse(Call<Object> call, Response<Object> response) {
                    view.showSuccessSnackBar("Transfer successful");
                    view.hideProgressBar();
                    view.exit();
                }
            });
